        ...
        <div className="flex items-center justify-center min-h-screen bg-teal-800">
            <div className="w-full max-w-md">
                <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 border-4 border-lime-300">
                    <h2 className="text-2xl mb-6 text-center font-bold text-teal-800">Login</h2>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <a className="inline-block align-baseline font-bold text-sm text-teal-500 hover:text-teal-800" href="/register">
                            Register
                        </a>
                    </div>
                </form>
